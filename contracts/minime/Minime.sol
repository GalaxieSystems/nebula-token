...
////////////////
    ...
    function Minime(
        ...
        parentToken = Minime(_parentToken);
...
///////////////////
    ...
    /// @param _amount The amount of tokens to be transferred
    /// @return True if the transfer was successful
    function doTransfer(address _from,
                        address _to, 
                        uint _amount) 
...
////////////////
    ...
    function updateValueAtNow(Checkpoint[] storage checkpoints, uint _value) 
        ...
        || (checkpoints[checkpoints.length -1].fromBlock < block.number)) {
               ...
               Checkpoint memory oldCheckPoint = checkpoints[checkpoints.length-1];
...
////////////////
    ...
    event ClaimedTokens(address indexed _token,
    ...
    event NewCloneToken(address indexed _cloneToken,
                        uint _snapshotBlock);
